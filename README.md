...
- **Оценка цен на недвижимость (Kaggle House Prices)** — регрессия, сравнение моделей, инженерия признаков (`ML_projects/04_ml_classic/Оценка цен на недвижимость (Kaggle House Prices) (1).ipynb`)
...
- **Прогноз истощения абсорбента NaOH (промышленная аналитика)** — регрессия + бизнес-интерпретация результата (`ML_projects/05_ml_business/Прогноз истощения абсорбента NaOH в абсорбере (промышленная аналитика) (1).ipynb`)
...
- **Классификация токсичных комментариев (BERT)** — улучшение baseline, тестовые метрики (`ML_projects/06_nlp/Классификация токсичных комментариев (BERT) (2).ipynb`)
- **NLP-аналитика отзывов** — тональность/аспекты/summary на LLM (Qwen), прикладной пайплайн (`ML_projects/06_nlp/NLP-аналитика отзывов - тональность, аспекты и резюме (LLM, Qwen) (3).ipynb`)
- **Кластеризация товаров продавца** — embeddings + UMAP + HDBSCAN/DBSCAN, метрики кластеризации (`ML_projects/06_nlp/Кластеризация товаров продавца (1).ipynb`)
